        ...
        <div class="row">
            <div class="col-lg-6 mx-auto" style="background-color: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1);">
                <div class="login_form_inner">
                    ...
                    <form class="row login_form" action="/forgot" method="post" id="form-data">
                        <div class="col-md-12 form-group" style="margin-bottom: 20px;">
                            <input type="text" class="form-control" id="name" name="email" placeholder="Email" style="width: 100%; padding: 15px; border: 1px solid #ddd; border-radius: 5px; font-size: 16px;">
                            <div class="alert text-danger" style="padding: 10px 0 0 0; margin-bottom:0; margin-left:7px;"></div>
                        </div>
                        <div class="col-md-12 form-group" style="margin-bottom: 20px;">
                            <button type="submit" onclick="forgot('/forgot',event)" value="submit" class="primary-btn" style="background-color: #81c408; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; border: none; width: 100%;">Tiếp theo</button>
                            <br>
                        </div>
                    </form>
